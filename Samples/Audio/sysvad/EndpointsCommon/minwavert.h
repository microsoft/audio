...
public:
    ...
    static NTSTATUS GetAttributeFromAttributeList
    (
        _In_ const KSMULTIPLE_ITEM *_pAttributes,
...
public:
    ...
    NTSTATUS PropertyHandlerAudioLoopbackTappointCaps
    (
        _In_ PPCPROPERTY_REQUEST      PropertyRequest
    );
...
#pragma code_seg()
    ...
    BOOL IsLoopbackTapPointSupported()
    {
        return (IsLoopbackSupported() && (m_DeviceFlags & ENDPOINT_LOOPBACK_TAPPOINT_SUPPORTED)) ? TRUE : FALSE;
    }
    ...
    PINTYPE GetPinType(ULONG nPinId);
