...
#define HDMI_MPEGH_PROFILE1_MAX_CHANNELS         8       // Max Channels.
#define HDMI_MPEGH_PROFILE1_MIN_BITS_PER_SAMPLE  16      // Min Bits Per Sample
#define HDMI_MPEGH_PROFILE1_MAX_BITS_PER_SAMPLE  16      // Max Bits Per Sample
#define HDMI_MPEGH_PROFILE1_MIN_SAMPLE_RATE      32000   // Min Sample Rate
#define HDMI_MPEGH_PROFILE1_MAX_SAMPLE_RATE      192000  // Max Sample Rate
    ...
    { // 8
        {
            ...
            0,
            STATICGUIDOF(KSDATAFORMAT_TYPE_AUDIO),
            STATICGUIDOF(KSDATAFORMAT_SUBTYPE_IEC61937_MPEGH_LEVEL1_LC),
            STATICGUIDOF(KSDATAFORMAT_SPECIFIER_WAVEFORMATEX)
        },
        {
            {
    ...
    { // 16
        {
            ...
            0,
            STATICGUIDOF(KSDATAFORMAT_TYPE_AUDIO),
            STATICGUIDOF(KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21_PROFILE4),
            STATICGUIDOF(KSDATAFORMAT_SPECIFIER_WAVEFORMATEX)
        },
        {
            {
...
KSDATARANGE_AUDIO HdmiPinDataRangesStream[] =
{
    ...
    { // 4 -  MPEG-H Profile 1 host
        ...
        HDMI_MPEGH_PROFILE1_MAX_CHANNELS,
        HDMI_MPEGH_PROFILE1_MIN_BITS_PER_SAMPLE,
        HDMI_MPEGH_PROFILE1_MAX_BITS_PER_SAMPLE,
        HDMI_MPEGH_PROFILE1_MIN_SAMPLE_RATE,
        HDMI_MPEGH_PROFILE1_MAX_SAMPLE_RATE
    },
    { // 5 - DTS host
        {
            sizeof(KSDATARANGE_AUDIO),
...
PKSDATARANGE HdmiPinDataRangePointersStream[] =
{
    ...
    PKSDATARANGE(&PinDataRangeAttributeList),
    PKSDATARANGE(&HdmiPinDataRangesStream[10]),
    PKSDATARANGE(&PinDataRangeAttributeList),
    PKSDATARANGE(&HdmiPinDataRangesStream[11]),
    PKSDATARANGE(&PinDataRangeAttributeList)
};
...
PKSDATARANGE HdmiPinDataRangePointersBridge[] =
{
    ...
    &HdmiPinDataRangesBridge[9],
    &HdmiPinDataRangesBridge[10]
};
