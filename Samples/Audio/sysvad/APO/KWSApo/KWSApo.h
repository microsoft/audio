...
// Description:
//
//   Declaration of the CKWSApoMFX class.
//
...
class CKWSApoMFX :
    ...
    public CComCoClass<CKWSApoMFX, &CLSID_KWSApoMFX>,
...
public:
    ...
    virtual ~CKWSApoMFX();    // destructor

DECLARE_REGISTRY_RESOURCEID(IDR_KWSAPOMFX)

BEGIN_COM_MAP(CKWSApoMFX)
    COM_INTERFACE_ENTRY(IKWSApoMFX)
...
OBJECT_ENTRY_AUTO(__uuidof(KWSApoMFX), CKWSApoMFX)
