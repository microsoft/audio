...
class CSwapAPOMFX :
    ...
    public IAudioProcessingObjectNotifications2,
...
BEGIN_COM_MAP(CSwapAPOMFX)
    ...
    COM_INTERFACE_ENTRY(IAudioProcessingObjectNotifications2)
...
public:
    ...
    STDMETHODIMP GetApoNotificationRegistrationInfo(_Out_writes_(0) APO_NOTIFICATION_DESCRIPTOR **, _Out_ DWORD *)  {return E_NOTIMPL;};

    // IAudioProcessingObjectNotifications1
    STDMETHODIMP GetApoNotificationRegistrationInfo2(APO_NOTIFICATION_TYPE maxType, _Out_writes_(*count) APO_NOTIFICATION_DESCRIPTOR **apoNotifications, _Out_ DWORD *count);
...
private:
    ...
    BOOL                                    m_bAudioEnvironmentStateNotificationsAvailable = FALSE;

    // Only valid if m_bAudioEnvironmentStateNotificationsAvailable is TRUE:
    BOOL                                    m_bIsSpatialAudioInUse  = FALSE;
